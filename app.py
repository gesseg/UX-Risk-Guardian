...
# Ensure local package import works on Streamlit Cloud
BASE_DIR = Path(__file__).parent.resolve()
import sys
if str(BASE_DIR) not in sys.path:
    sys.path.insert(0, str(BASE_DIR))

from auraux.knowledge import load_kb, retrieve_by_query, phase_presets
from auraux.eu_ai_mapper import map_to_eu_ai_act, map_to_other_frameworks
from auraux.formatting import render_numeric_citations, build_reference_dict
from auraux.pdf_export import export_result_to_pdf
...
# Robust, repo-relative file paths
